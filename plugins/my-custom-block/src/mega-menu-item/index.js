...
const DROPDOWN_CLASSES =
	'absolute top-full left-0 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 w-screen max-w-4xl bg-white shadow-2xl rounded-b-lg p-8 z-50';
const ALLOWED_BLOCKS = [
	'create-block/my-footer-row',
